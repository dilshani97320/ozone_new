...
{path:'',component:FHomeComponent},
{path:'class',component:FClassComponent},
{path:'login',component:FLoginComponent},
{path:'about',component:FAboutComponent},
//{path:'contactus',component:ContactusComponent},
{path:'register',component:FRegisterComponent},
{path:'classregistration',component:FClassRegistrationComponent},
{path:'teachers',component:FTeachersComponent},
